...
![MSRV 1.83+](https://img.shields.io/badge/rustc-1.83+-blue.svg)
...
The MSRV of owo-colors is **Rust 1.83**.

This library has a conservative MSRV policy — Rust versions from the last 12 months will be supported, the MSRV will only be bumped if required, and if the MSRV is bumped it will always occur with a new minor version.
