...
impl From<DosingPumpTarget> for crate::pump::PumpType {
    fn from(t: DosingPumpTarget) -> Self {
        match t {
            DosingPumpTarget::NutrientA => crate::pump::PumpType::NutrientA,
            DosingPumpTarget::NutrientB => crate::pump::PumpType::NutrientB,
            DosingPumpTarget::PhUp => crate::pump::PumpType::PhUp,
            DosingPumpTarget::PhDown => crate::pump::PumpType::PhDown,
        }
    }
}
