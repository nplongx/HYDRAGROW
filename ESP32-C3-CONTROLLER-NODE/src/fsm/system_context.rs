...
impl SystemContext {
    ...
    pub fn sync_to_legacy(&self, legacy: &mut ControlContext, now_ms: u64) {
        legacy.current_state = match &self.phase {
            ...
            SystemPhase::WaterRefilling => SystemState::WaterRefilling { target_level: 0.0, timeout_sec: 0 },
            SystemPhase::WaterDraining => SystemState::WaterDraining { target_level: 0.0, timeout_sec: 0 },
