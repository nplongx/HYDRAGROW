...
const char *command_secret = "change-me-device-secret";
const long COMMAND_TS_WINDOW_SEC = 300;
const size_t NONCE_CACHE_SIZE = 16;
String used_nonces[NONCE_CACHE_SIZE];
size_t used_nonce_index = 0;
