...
=======
- Baseline lock script cho tuần 3: `scripts/check_quality_regression.sh` với baseline tại `docs/process/baseline-metrics.env` (bật bằng repo variable `ENABLE_BASELINE_LOCK=true`).
>>>>>>> main
