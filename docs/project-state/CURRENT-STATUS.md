...
- FSM Trigger UI Cleanup (AUTOMATION-FSM-CLEANUP-001): VERIFIED — Removed decorative non-backed FSM trigger fields from NodeEditorPanel and replaced tab with clear explanation of Condition + advance_stage/end_season mechanism.
