...
| Controller / firmware | VERIFIED | HMAC-VERIFICATION-001 HMAC signature verification for signed MQTT payloads moved into hydragrow-controller-core and verified with unit tests and evidence contract. |
