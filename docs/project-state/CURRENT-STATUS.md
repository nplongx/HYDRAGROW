...
- Remove Unsafe MQTT Tests (backend-unsafe-removal): VERIFIED - Extracted env var resolution logic allowing tests to inject mocked configs, removed unsafe blocks from `mqtt_utils.rs` tests.
