...
| Controller / firmware | VERIFIED | PUMP-SOFTSTART-001 Osaka pump soft-start generation counter race condition fix verified with cargo check --target riscv32imc-esp-espidf and evidence contract. |
