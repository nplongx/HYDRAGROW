...
| Frontend | VERIFIED | AUTOMATION-UI-OVERHAUL-001 Rebuilt the Automation page UI around one coherent responsive React Flow experience, verified with Vitest tests and evidence contract. |
