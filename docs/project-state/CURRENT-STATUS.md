...
- AI Supervisor Backend Foundations (AI-SUPERVISOR-BACKEND-001): VERIFIED — scoped service API keys, SupervisorReasonCode enum, system_events source & primary_reason_code columns, alert dedup lookup and endpoints, and per-topic liveness tracking.
