...
| Controller / firmware | VERIFIED | SAFETY-OVERRIDE-001 safety_override_until read-site wired to bypass non-emergency safety budgets in MonitoringPhase, verified with Cargo test suite and evidence contract. |
