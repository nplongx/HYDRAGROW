...
| LOG-NEUTRAL-LEGEND-001 | AC-1 Neutral token & utility classes in App.css & CHUAN-GIAO-DIEN-FRONTEND.md; AC-2 EventLegend component; AC-3 EventLegend unit tests; AC-4 CI quality gates | `hydragrow-frontend/src/App.css`, `hydragrow-frontend/src/components/logs/EventLegend.tsx`, `hydragrow-frontend/CHUAN-GIAO-DIEN-FRONTEND.md` | `docs/evidence/LOG-NEUTRAL-LEGEND-001.json`, Vitest unit tests | Frontend / Web | `docs/acceptance/LOG-NEUTRAL-LEGEND-001.json` | VERIFIED |
