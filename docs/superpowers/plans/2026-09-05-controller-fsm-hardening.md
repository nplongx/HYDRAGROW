...
- [ ] **Task 1: Establish a Clean Build/Test Baseline**
...
- [ ] **Task 2: Make ContextDelta Merging Field-Wise**
...
- [ ] **Task 3: Make Event Dispatch Transactional on Hardware Fault**
...
- [ ] **Task 4: Centralize Terminal Stop / Fault / Calibration Actor Reset**
...
- [ ] **Task 5: Repair Calibration Lifecycle and Timeout**
...
- [ ] **Task 6: Harden Sensor Ingress and Freshness**
...
- [ ] **Task 7: Make WaterActor Result Semantics Explicit**
...
- [ ] **Task 8: Make Dosing Planning Transactional With Safety Budget**
...
- [ ] **Task 9: Correct Delivered-Volume Accounting and Pump-B Start Semantics**
...
- [ ] **Task 10: Make Water Hardware Stop and Retry Reliable**
...
- [ ] **Task 11: Make Peripheral Decisions Use Final Same-Tick Intent**
...
- [ ] **Task 12: Unify Recipe Activation, Persistence, and Clear**
...
- [ ] **Task 13: Route Scheduled Water Through Common Amount + Safety Planning**
...
- [ ] **Task 14: Define Runtime Config/Recipe Semantics for In-Flight Jobs**
...
- [ ] **Task 15: Formalize Safety-Budget Scope and Numeric Validation**
...
- [ ] **Task 16: Add Cross-Layer FSM Regression Scenarios**
...
- [ ] **Task 17: Final Static Audit / Verification Gate**
