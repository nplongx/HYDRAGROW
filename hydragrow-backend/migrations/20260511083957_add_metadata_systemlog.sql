...
ALTER TABLE system_events ALTER COLUMN metadata TYPE JSONB USING metadata::JSONB;
...
ON system_events USING GIN ((metadata -> 'cycle_id'));
...
ON system_events USING GIN ((metadata -> 'event_type'));
