-- hydragrow-backend/migrations/20260819111700_add_crop_recipes_jsonb.sql
-- Thêm bảng crop_recipes, crop_recipe_stages (JSONB target_config),
-- device_active_recipes và indexes tương ứng.
...
-- Recipe lifecycle events in system_events
