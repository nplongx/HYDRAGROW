...
//             enable_water_level_sensor: sens.enable_water_level_sensor, enable_temp_sensor: sens.enable_temp_sensor, dosing_pwm_percent: dose.dosing_pwm_percent as u32, osaka_mixing_pwm_percent: dose.osaka_mixing_pwm_percent as u32, osaka_misting_pwm_percent: dose.osaka_misting_pwm_percent as u32, scheduled_dosing_enabled: dose.scheduled_dosing_enabled, scheduled_dosing_cron: dose.scheduled_dosing_cron.clone(),
