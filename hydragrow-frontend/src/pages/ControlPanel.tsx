    ...
    <div className="app-page max-w-5xl">
      ...
      <div className="relative border border-emerald-100 rounded-3xl p-5 md:p-6 bg-white/80 backdrop-blur-sm space-y-6 overflow-hidden shadow-sm shadow-emerald-950/5 mt-4">
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <AdvancedDeviceControl deviceId={deviceId} pumpId="WATER_PUMP_IN" title="Van cấp nước" icon={Droplets} currentStatus={Boolean(pumps.water_pump_in)} allowPwm={false} colorTheme="blue" canSendCommands={canSendCommands} isEmergency={isEmergency} isAutoMode={isAutoMode} />
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <AdvancedDeviceControl deviceId={deviceId} pumpId="OSAKA" title="Bơm trộn tuần hoàn" icon={Power} currentStatus={Boolean(pumps.osaka_pump)} allowPwm={true} colorTheme="indigo" canSendCommands={canSendCommands} isEmergency={isEmergency} isAutoMode={isAutoMode} />
